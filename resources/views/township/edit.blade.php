        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">Township Edit</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="animated fadeIn"><!-- div class=FadeIn start -->
        <div class="card"><!-- card start -->
            ...
            <div class="card-header"><!-- card-header start -->
                <strong class="card-title">Township Edit</strong>
            </div><!-- card-header end -->
    
            <div class="card-body">  <!-- card-body start -->

			<form action="/backend/township/update/<?php echo $township[0]->id; ?>" method="post">
	...
	$township[0]->description; ?>' />
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="status" id="status">
							...
							<option value="1" @if($township[0]->status == 1) selected @endif>Active</option>
							<option value="0" @if($township[0]->status == 0) selected @endif>Inactive</option>        
						</select>
                        <br>
                    </div>
                </div><!-- div class=row One end -->
