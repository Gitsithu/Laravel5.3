    ...
    <div class="animated fadeIn"><!-- div class=FadeIn start -->
        <div class="card"><!-- card start -->
            ...
            <div class="card-header"><!-- card-header start -->
                <strong class="card-title">Course Edit</strong>
            </div><!-- card-header end -->
    
            <div class="card-body">  <!-- card-body start -->

			<form action="/backend/course/update/<?php echo $courses[0]->id; ?>" method="post" enctype="multipart/form-data">
	...
	$courses[0]->fee; ?>' />
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="status" id="status">
							...
							<option value="1" @if($courses[0]->status == 1) selected @endif>Active</option>
							<option value="0" @if($courses[0]->status == 0) selected @endif>Inactive</option>        
						</select>
                        <br>
                    </div>
